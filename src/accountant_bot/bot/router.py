...
from accountant_bot.bot.keyboards import (
    ai_consult_keyboard,
...
from accountant_bot.bot.messages import (
...
from accountant_bot.bot.states import AIConsultStates, FinanceInputStates, OnboardingStates, RegimeSelectionStates
from accountant_bot.core.clock import utcnow
from accountant_bot.core.config import get_settings
from accountant_bot.core.rate_limit import allow_ai_request
from accountant_bot.db.enums import EntityType, FinanceRecordType, PaymentStatus, SubscriptionPlan, TaxRegime
from accountant_bot.db.session import SessionFactory
from accountant_bot.services.container import build_services
from accountant_bot.services.finance_parser import EXPENSE_CATEGORY_LABELS, INCOME_CATEGORY_LABELS
from accountant_bot.services.onboarding import OnboardingDraft
from accountant_bot.services.profile_matching import ProfileContext
from accountant_bot.services.subscription import PLAN_DETAILS
from accountant_bot.services.tax_engine import TaxQueryParser
...
def build_router() -> Router:
    ...
    async def do_ai_answer(message: Message, question: str) -> None:
        ...
        async with SessionFactory() as session:
            ...
            from accountant_bot.db.models import AIDialog
            result = await session.execute(
                select(AIDialog)
